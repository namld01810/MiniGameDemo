              ...
              bubbleImageView:(UIImageView *)bubbleImageView
{
    ...
    if (self) {
        ...
        pImgView.image = [UIImage imageNamed:@"ic_no_avatar.jpg"];
        [self addSubview:pImgView];
        [self bringSubviewToFront:pImgView];
        _pImgView = pImgView;
#endif
        // end khanh
...
//    if (NSFoundationVersionNumber > NSFoundationVersionNumber_iOS_6_0) {
    if (NSFoundationVersionNumber >= NSFoundationVersionNumber_iOS_7_0) { // khanh add for ios8 sdk
    ...
    return CGSizeMake(roundf(stringSize.width), roundf(stringSize.height + 10.f));
}
