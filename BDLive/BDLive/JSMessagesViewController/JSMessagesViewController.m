...
#define BD_HEADER_NAV 47.f // khanh add
...
- (void)setup
{
    ...
    // khanh add
    CGRect tblRect = CGRectMake(self.view.frame.origin.x, self.view.frame.origin.y + BD_HEADER_NAV, self.view.frame.size.width, self.view.frame.size.height - BD_HEADER_NAV);
//    if (floor(NSFoundationVersionNumber) > NSFoundationVersionNumber_iOS_6_1) {
//        tblRect = CGRectMake(self.view.frame.origin.x, self.view.frame.origin.y + BD_HEADER_NAV, self.view.frame.size.width, self.view.frame.size.height - BD_HEADER_NAV - 20);
//    }
    
//	JSMessageTableView *tableView = [[JSMessageTableView alloc] initWithFrame:self.view.frame style:UITableViewStylePlain];
    JSMessageTableView *tableView = [[JSMessageTableView alloc] initWithFrame:tblRect style:UITableViewStylePlain];
...
{
    [self.tableView reloadData];
    [self.messageInputView.textView setText:self.messageInputView.textView.text];
}
...
- (void)keyboardWillShowHide:(NSNotification *)notification
{
    ...
    [UIView animateWithDuration:duration
                     ...
                     animations:^{
                         ...
                         if (floor(NSFoundationVersionNumber) > NSFoundationVersionNumber_iOS_7_1 && [notification.name isEqualToString:UIKeyboardWillShowNotification]) {
                             // khanh fix for ios7 and later
                             inputViewFrameY -= 20;
                         }
