...
@interface MaytinhDuDoanController ()<SOAPHandlerDelegate, UITableViewDataSource, UITableViewDelegate>
...
@implementation MaytinhDuDoanController
...
-(void)fetchListMaytinhDuDoan
{
    ...
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(0.1 * NSEC_PER_SEC)), myQueue, ^{
        ...
        [self.soapHandler sendSOAPRequest:[PresetSOAPMessage getMaytinhDuDoanListMessage:page] soapAction:[PresetSOAPMessage getMaytinhDuDoanListSoapAction]];
...
-(void)onSoapDidFinishLoading:(NSData *)data
{
    @try {
        ...
        NSString* jsonStr = [[xmlData componentsSeparatedByString:@"<wsFootBall_Lives_Co_MayTinhDuDoanResult>"] objectAtIndex:1];
        jsonStr = [[jsonStr componentsSeparatedByString:@"</wsFootBall_Lives_Co_MayTinhDuDoanResult>"] objectAtIndex:0];
