...
{
    CGFloat element1Width = 0.0f;
    CGFloat element2Width = 0.0f;
    
    CGFloat elementTmpWidth = 100.0f; // khanh add for temp
    
    if([element1 isKindOfClass:[UILabel class]] )
    {
        [(UILabel*)element1 setTextAlignment:NSTextAlignmentRight];
        
        // khanh fix for compatible with ios6
        if ([@"" respondsToSelector:@selector(sizeWithAttributes:)]) {
            ...
            CGSize expectedLabelSize = [((UILabel*)element1).text sizeWithFont:((UILabel*)element1).font
                                              constrainedToSize:maximumLabelSize
                                                  lineBreakMode:((UILabel*)element1).lineBreakMode];
            element1Width = expectedLabelSize.width;
    ...
    if([element2 isKindOfClass:[UILabel class]])
    {
        ...
        if ([@"" respondsToSelector:@selector(sizeWithAttributes:)]) {
            ...
            CGSize expectedLabelSize = [((UILabel*)element2).text sizeWithFont:((UILabel*)element2).font
                                                             constrainedToSize:maximumLabelSize
                                                                 lineBreakMode:((UILabel*)element2).lineBreakMode];
            element2Width = expectedLabelSize.width;
...
//    NSLog(@"element1Width: %f", element1Width);
//    NSLog(@"element2Width: %f", element2Width);
